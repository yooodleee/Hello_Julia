...
Basic structure for XML get part of Xdmf file is
<?xml version="1.0" encoding="utf-8">
<Xdmf xmlns:xi="https://www.w3.org/2001/XInclude" Version="2.1">
    <Domain>
...
Returns some specific child xml element from an array of XMLElement based on,
...
References
-------------
[1] http://www.xdmf.org/php/XDMF_Model_and_Format
"""
...
julia> traverse(xdmf, "/Domain/Grid[2]/Grid[@Name=Frame 1]/DataItem")
"""
function traverse(x, attr_name)
...
Return a SpatialCollection at given time either by creating new one or 
...
function update_xdmf!(xdmf::Xdmf, problem::Problem, time::Float64, fields::Vector)
    ...
    # 2.1 make sure that Grid element you found really is TemporalCollection
    ...
    X_dataitem = new_child(xdmf, X_array)
